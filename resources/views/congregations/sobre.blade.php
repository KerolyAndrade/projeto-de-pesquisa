            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header text-center">
                        <h1 class="mb-0">Estudo: Congregações Católicas, Educação e Estado Nacional</h1>
                    </div>
                    <div class="card-body">
                        <section>
                        ...
                        <section>
                            ...
                            <p>Outros resultados do Projeto podem ser encontrados especialmente nos seguintes dossiês:</p>
                            <ul>
                                <li>Dossiê “Catolicismo e Formação Cultural”, Pró-Posições (UNICAMP. Impresso), 0103-7307, v.25, n 72.</li>
                                <li>Dossiê Políticas Católicas: educação, arte e religião. Revista Brasileira de História da Educação, Campinas-SP, v. 15, n. 2 (38), maio/agosto 2015. <a href="https://www.rbhe.sbhe.org.br" target="_blank">Link</a>.</li>
